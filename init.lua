...
do
	...
	-- [[ Fugitive ]]
	-- Repository-level Git interface.
	-- Run :Git to open Git status.
	...
	-- [[ Undotree ]]
	-- Visualizes the full undo history, including branching changes.
...
do
	...
	vim.api.nvim_create_autocmd("LspAttach", {
		...
		desc = "Use BasedPyright instead of Ruff for Python hover",
	})
